...
from attack.mi_2_fgsm import MI_2_FGSM
import timm

def get_args_parser():
    parser = argparse.ArgumentParser('MI_2_FGSM Attack in pytorch', add_help=False)
    ...
    parser.add_argument('--alpha', default=1.6/255.0, type=float,
                        help='the alpha')
    ...
    parser.add_argument('--model_2', default='inc_v4', type=str,
                        help='the white model')
    parser.add_argument('--model_path', default=None, type=str,
                        help='the path of white model')
    parser.add_argument('--target_model', default='inc_res_v2_ens', type=str,
...
def main(args):
    ...
    if args.dataset == 'imagenet':
        if args.model_1 == 'resnet101':
            ...
            input_size = 224
        elif args.model_1 in ['inc_v3', 'inc_v4','inc_res_v2', 'inc_res_v2_ens', 'inc_v3_adv']:
            transform =  transforms.Compose([
    ...
    elif args.model_1 == 'inc_v4':
        model_1 = timm.create_model('inception_v4', pretrained=True)
    elif args.model_1 == 'inc_res_v2':
        model_1 = timm.create_model('inception_resnet_v2', pretrained=True)
    elif args.model_1 == 'inc_res_v2_ens':
        model_1 = timm.create_model('ens_adv_inception_resnet_v2', pretrained=True)
    elif args.model_1 == 'inc_v3':
        model_1 = models.inception_v3(pretrained=True)
    elif args.model_1 == 'inc_v3_adv':
        model_1 = timm.create_model('inception_v3.tf_adv_in1k', pretrained=True)

    # load model_1
    print("load model_2!!!")
    if args.model_2 == 'resnet101':
        model_2 = models.resnet101(pretrained=True)
    elif args.model_2 == 'inc_v4':
        model_2 = timm.create_model('inception_v4', pretrained=True)
    elif args.model_2 == 'inc_res_v2':
        model_2 = timm.create_model('inception_resnet_v2', pretrained=True)
    elif args.model_2 == 'inc_res_v2_ens':
        model_2 = timm.create_model('ens_adv_inception_resnet_v2', pretrained=True)
    elif args.model_2 == 'inc_v3':
        model_2 = models.inception_v3(pretrained=True)
    elif args.model_2 == 'inc_v3_adv':
        model_2 = timm.create_model('inception_v3.tf_adv_in1k', pretrained=True)
    ...
    if args.target_model == 'inc_v3':
        ...
        target_model = timm.create_model('ens_adv_inception_resnet_v2', pretrained=True)
    ...
    attack = MI_2_FGSM(model_1, model_2, loss, eps, alpha=args.alpha, steps=args.step, decay=args.decay)
