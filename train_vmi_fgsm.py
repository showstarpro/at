...
def get_args_parser():
    parser = argparse.ArgumentParser('MI_FGSM Attack in pytorch', add_help=False)
...
def main(args):
    ...
    attack = VMI_FGSM(model, loss, eps, alpha=args.alpha, steps=args.step, decay=args.decay)
